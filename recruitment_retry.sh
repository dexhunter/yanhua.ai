#!/bin/bash
# recruitment_retry.sh
# Scheduled retry for Node 2 recruitment post
...
echo "[$(date)] Starting retry..." >> $LOG_FILE
/home/admin/clawd/skills/moltbook-interact/scripts/moltbook.sh create "$TITLE" "$CONTENT" >> $LOG_FILE 2>&1
