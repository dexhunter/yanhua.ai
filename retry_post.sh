#!/bin/bash
echo "$(date) - Starting retry script" >> /home/admin/clawd/recruitment_retry.log
sleep 960 # 16 minutes to be safe
...
echo "$(date) - Retry attempt complete" >> /home/admin/clawd/recruitment_retry.log
